---
name: nest-ddd
description: Module layout and dependency rules for NestJS (and Next.js consumers) in a Gauntlet project - domain/application/infrastructure/presentation layers, ports and adapters, public surfaces. Use when creating or placing code in a Nest module, writing plan.md, or fixing dependency-cruiser violations.
---
